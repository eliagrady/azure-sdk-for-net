...
namespace Azure.ResourceManager.SecurityCenter
{
    ...
    public partial class SecuritySettingCollection : ArmCollection, IEnumerable<SecuritySettingResource>, IAsyncEnumerable<SecuritySettingResource>
    {
        ...
        public virtual async Task<ArmOperation<SecuritySettingResource>> CreateOrUpdateAsync(WaitUntil waitUntil, SettingNameAutoGenerated settingName, SecuritySettingData data, CancellationToken cancellationToken = default)
        {
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="data"/> is null. </exception>
        public virtual ArmOperation<SecuritySettingResource> CreateOrUpdate(WaitUntil waitUntil, SettingNameAutoGenerated settingName, SecuritySettingData data, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(data, nameof(data));
        ...
        /// <param name="settingName"> The name of the setting. </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual async Task<Response<SecuritySettingResource>> GetAsync(SettingNameAutoGenerated settingName, CancellationToken cancellationToken = default)
        {
        ...
        /// <param name="settingName"> The name of the setting. </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual Response<SecuritySettingResource> Get(SettingNameAutoGenerated settingName, CancellationToken cancellationToken = default)
        {
            using var scope = _securitySettingSettingsClientDiagnostics.CreateScope("SecuritySettingCollection.Get");
            scope.Start();
            try
        ...
        /// <param name="settingName"> The name of the setting. </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual async Task<Response<bool>> ExistsAsync(SettingNameAutoGenerated settingName, CancellationToken cancellationToken = default)
        {
        ...
        /// <param name="settingName"> The name of the setting. </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual Response<bool> Exists(SettingNameAutoGenerated settingName, CancellationToken cancellationToken = default)
        {
            using var scope = _securitySettingSettingsClientDiagnostics.CreateScope("SecuritySettingCollection.Exists");
            scope.Start();
            try
        ...
        /// <param name="settingName"> The name of the setting. </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual async Task<NullableResponse<SecuritySettingResource>> GetIfExistsAsync(SettingNameAutoGenerated settingName, CancellationToken cancellationToken = default)
        {
        ...
        /// <param name="settingName"> The name of the setting. </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual NullableResponse<SecuritySettingResource> GetIfExists(SettingNameAutoGenerated settingName, CancellationToken cancellationToken = default)
        {
            using var scope = _securitySettingSettingsClientDiagnostics.CreateScope("SecuritySettingCollection.GetIfExists");
            scope.Start();
            try
