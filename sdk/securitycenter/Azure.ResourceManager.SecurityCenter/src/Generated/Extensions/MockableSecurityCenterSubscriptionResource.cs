...
namespace Azure.ResourceManager.SecurityCenter.Mocking
{
    ...
    public partial class MockableSecurityCenterSubscriptionResource : ArmResource
    {
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        [ForwardsClientCalls]
        public virtual async Task<Response<SecuritySettingResource>> GetSecuritySettingAsync(SettingNameAutoGenerated settingName, CancellationToken cancellationToken = default)
        {
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        [ForwardsClientCalls]
        public virtual Response<SecuritySettingResource> GetSecuritySetting(SettingNameAutoGenerated settingName, CancellationToken cancellationToken = default)
        {
