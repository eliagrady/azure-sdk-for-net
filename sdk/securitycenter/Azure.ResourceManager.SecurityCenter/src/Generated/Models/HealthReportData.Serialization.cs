                ...
                if (property.NameEquals("properties"u8))
                {
                    ...
                    foreach (var property0 in property.Value.EnumerateObject())
                    {
                        if (property0.NameEquals("resourceDetails"u8))
                        {
                            ...
                            resourceDetails = ResourceDetailsAutoGenerated.DeserializeResourceDetailsAutoGenerated(property0.Value);
                            continue;
                        }
                        ...
                        if (property0.NameEquals("status"u8))
                        {
                            ...
                            status = StatusAutoGenerated.DeserializeStatusAutoGenerated(property0.Value);
                            continue;
                        }
