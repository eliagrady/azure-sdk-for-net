...
{
    public partial class StatusAutoGenerated : IUtf8JsonSerializable
    {
        ...
        internal static StatusAutoGenerated DeserializeStatusAutoGenerated(JsonElement element)
        {
            ...
            return new StatusAutoGenerated(Optional.ToNullable(code), reason.Value, Optional.ToNullable(lastScannedDate), Optional.ToNullable(statusChangeDate), Optional.ToNullable(firstEvaluationDate));
        }
    }
}
